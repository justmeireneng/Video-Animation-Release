...
class ProviderRegistry:
    def __init__(self, factories: dict[str, Callable[[], VoiceProvider]] | None = None):
        self._factories = factories or {
            ...
            "voicestudio": _lazy("src.providers.voice.voicestudio", "VoiceStudioProvider"),
        }
    ...
    def resolve(self, provider_id: str, *, fallback: bool = True) -> ProviderResolution:
        ...
        if requested != DEFAULT_VOICE_PROVIDER and not provider.is_available():
            if not fallback:
